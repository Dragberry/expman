...
CREATE TABLE INSTRUCTION (
	...
	CONSTRAINT FK_COUNTER_PARTY_INSTRUCTION FOREIGN KEY (COUNTER_PARTY_KEY) REFERENCES COUNTER_PARTY (COUNTER_PARTY_KEY)
) ENGINE=INNODB;

CREATE TABLE TRANSACTION (
	TRANSACTION_KEY BIGINT AUTO_INCREMENT NOT NULL,
	INSTRUCTION_KEY BIGINT NOT NULL,
	AMOUNT NUMERIC(19,2),
	...
	CONSTRAINT FK_TRANSACTION_INSTRUCTION FOREIGN KEY (INSTRUCTION_KEY) REFERENCES INSTRUCTION (INSTRUCTION_KEY),
